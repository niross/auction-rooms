...
from auctioneer.common.models import DeletableTimeStampedModel
from auctioneer.experiences.models import Experience
from auctioneer.users.models import User
from auctioneer.currencies.models import Currency
...
class Auction(DeletableTimeStampedModel):
    ...
    def mark_complete(self):
        from auctioneer.auctions.signals import auction_completed
