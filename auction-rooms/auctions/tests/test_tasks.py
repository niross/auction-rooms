...
from auctioneer.auctions.models import Auction, Bid, Favourite
from auctioneer.auctions.tasks import increment_search_appearance_count, \
    increment_view_count, complete_auctions
from auctioneer.common.tests import BaseTestCase
from auctioneer.emailer.models import EmailLog
...
class AuctionTasksTestCase(BaseTestCase):
    ...
    @mock.patch('auction-rooms.auctions.signals.auction_completed.send')
