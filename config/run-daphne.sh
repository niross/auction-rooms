...
export MAILGUN_SENDER_DOMAIN=mg.luckybreak.sonick.co.uk
...
/home/nick/.virtualenvs/luckybreak/bin/daphne -b 0.0.0.0 -p 8080 -u /var/run/luckybreak-daphne.sock -v 2 config.asgi:channel_layer
