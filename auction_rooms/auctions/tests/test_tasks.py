...
from auction_rooms.auctions.models import Auction, Bid, Favourite
from auction_rooms.auctions.tasks import increment_search_appearance_count, \
...
class AuctionTasksTestCase(BaseTestCase):
    ...
    @mock.patch('auction_rooms.auctions.signals.auction_completed.send')
